...
public class EmtelSimples {
	...
	public void a_Receber() throws InterruptedException{
		...
		Thread.sleep(1000);
		dsl.escrever("frmSelProd:inputPsqAtivoNome", "PRODUTO SIMPLES");
		...
		/*Etapa de seleção de Armazém: quando existir só um, comentar linhas 92 à 94*/
		...
		Thread.sleep(2000);
		dsl.clicarBotao("button.btn:nth-child(2)");
		String recebimento = dsl.obterValorCampo("formCenter:recebimentoTabView:inputNumRecebimento");
		...
		dsl.clicarBotao(By.xpath("//form/div[3]/div/div/div[1]/div[2]/div/div[1]/span"));
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		Assert.assertEquals("Armazenamento realizado com sucesso.", 
	...
	public void b_Expedicao() throws InterruptedException{
		...
		dsl.clicarBotaoX("//div[6]/div/ul/li[2]");
		Thread.sleep(1000);
		/*Etapa de seleção de Armazém: quando existir só um, comentar linhas 203 à 204*/
		...
		dsl.escrever("formCenter:inputQuantidadeFracionada", "1");
		dsl.clicarBotao(By.id("formCenter:btConfirmarGTI"));
		
		Thread.sleep(1000);
		Assert.assertEquals("Mapa sem produtos para separar.", 
				dsl.obterTexto("formCenter:msgs_formCenter"));
